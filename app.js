        ...
        if (fbService.isDefined(contexts[1]) && contexts[1].name.includes('motivation_dialog_context')){
          ...
          if (like_minded == '') {
            ...
            if (like_minded != '' && proof_myself != '' && accountability != '' && showcase_skills != '' && self_development != ''  &&      lifestyle_improvement != '' && income_growth != '' && support_others != '' && making_progress != '') {
              ...
              updateIdService.motivation(conv_like_minded,conv_proof_myself,conv_accountability,conv_showcase_skills,conv_self_development,conv_lifestyle_improvement,conv_income_growth,conv_support_others,conv_making_progress,sender)
              fbService.handleMessages(messages, sender);
